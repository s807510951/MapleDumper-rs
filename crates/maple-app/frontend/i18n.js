...
const UNPACK_I18N = {
  en: {
    ...
    "unpack.nativeBin": "maple-unpack-native (optional)",
    "unpack.nativeBinPh": "Auto-detect beside the app or on PATH…",
  ...
  ja: {
    ...
    "unpack.nativeBin": "maple-unpack-native（任意）",
    "unpack.nativeBinPh": "アプリの隣または PATH から自動検出…",
  ...
  zh: {
    ...
    "unpack.nativeBin": "maple-unpack-native（可选）",
    "unpack.nativeBinPh": "在应用旁或 PATH 中自动检测…",
  ...
  ko: {
    ...
    "unpack.nativeBin": "maple-unpack-native(선택)",
    "unpack.nativeBinPh": "앱 옆이나 PATH에서 자동 감지…",
  ...
  he: {
    ...
    "unpack.nativeBin": "maple-unpack-native (אופציונלי)",
    "unpack.nativeBinPh": "זיהוי אוטומטי ליד היישום או ב-PATH…",
